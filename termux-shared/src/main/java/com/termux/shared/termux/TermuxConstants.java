...
public final class TermuxConstants {
    ...
    public static final String TERMUX_GITHUB_ORGANIZATION_NAME = "atermux"; // Default: "termux"
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "A Termux"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.termux"; // Default: "com.termux"
    /** Termux GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "atermux-app"; // Default: "termux-app"
